...
public class ApplicationSpecificationBuilder extends AbstractSpecificationBuilder<Application, UUID> {
  ...
  private Predicate equalsNameIgnoreCasePredicate(
    ...
    return builder.equal(builder.upper(root.get(CLIENTID)), builder.upper(builder.literal(clientId)));
  }
